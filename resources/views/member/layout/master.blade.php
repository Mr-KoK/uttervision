...
@include('member.layout.sidebare')
@include('member.layout.header')
@include('member.layout.main')

{{--Modals--}}
@if($user->check_privacy == 0)
    <div id="User_privacy" class="modal fade bd-example-modal-lg" data-keyboard="false" data-backdrop="static">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <div class="modal-avatar">
                        <p>read privacy and check agreement below to be continue</p>
                    </div>
                </div>
                <div class="modal-footer">
                    <label for="check-privacy" class="d-flex align-items-center">
                        <span class="d-inline-block mr-5">I agree this privacy</span>
                        <input id="check-privacy" class="check-privacy" type="checkbox">
                    </label>
                </div>
            </div>
        </div>
