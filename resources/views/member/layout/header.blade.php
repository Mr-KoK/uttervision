                ...
                <div class="icon-box">
                    ...
                    <div class="notification-list card">
                        ...
                        <div class="box-body">
                            ...
                            <div class="btn-view">
                                <a class="font-w600 h6" href="javascript:void(0)">View All</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img width="53" height="53" class="rounded-circle header-profile-user img-user-avatar mr-5"
                         src="{{$user->getAvatar()}}" alt="User Avatar"> <span class="pulse-css"></span>
                    <span class="info d-xl-inline-block  color-span">
								<span class="d-block fs-20 font-w600">{{$user->name}}</span>
								<span class="d-block fs-14">Member</span>
							</span>
