...
@section('head')
    ...
    <title>Register In App - UtterVision</title>
    ...
    <link rel="stylesheet" href='{{asset('assets/css/cpp/member/member-register.min.css')}}'>
...
@section('content')
    <div class="parent-login">
        <div class="login-page">
            ...
            <div class="text-top-login mb-3 pt-3">
                <div class="d-flex justify-content-center">
                    <div class="mx-1">
                        <h4>Register</h4>
                    </div>
                    <div class="mx-1 mt-2">
                        <p class="p-0 my-auto"> In Travel Application</p>
                    </div>
                </div>
            </div>
