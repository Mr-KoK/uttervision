                                            ...
                                            <td style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:10px;">
                                                <div style="font-family: Arial, sans-serif">
                                                    <div class="txtTinyMce-wrapper"
                                                        ...
                                                        <p style="margin: 0; font-size: 16px; text-align: center;"><span
                                                                    style="font-size:30px;color:#2b303a;"><strong>Verify Your Account</strong></span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div class="txtTinyMce-wrapper"
                                                        ...
                                                        <p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 22.5px;">
                                                            <span style="color:#808389;font-size:15px;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmodati mat tempor incididunt ut labore et dolore magna aliqua.</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td style="padding-left:10px;padding-right:10px;padding-top:15px;text-align:center;">
                                                <div align="center">
                                                    ...
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                 ...
                                                                 style="height:62px;width:159px;v-text-anchor:middle;"
                                                                 arcsize="57%" stroke="false" fillcolor="#0068a5">
                                                        <w:anchorlock/>
                                                        <v:textbox inset="0px,0px,0px,0px">
                                                            <center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px">
                                                    <![endif]--><a href="{{$link}}"
                                                                   style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#0068a5;border-radius:35px;width:auto;border-top:1px solid #0068a5;font-weight:400;border-right:1px solid #0068a5;border-bottom:1px solid #0068a5;border-left:1px solid #0068a5;padding-top:15px;padding-bottom:15px;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"
                                                                   target="_blank"><span
                                                                style="padding-left:30px;padding-right:30px;font-size:16px;display:inline-block;letter-spacing:normal;"><span
                                                                    style="font-size: 12px; line-height: 2; word-break: break-word; mso-line-height-alt: 24px;"><span
                                                                        ...
                                                                        style="font-size: 16px; line-height: 32px;"><strong>Verify Now!</strong></span></span></span></a>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-4" role="presentation"
                ...
                <tr>
                    <td>
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack"
                               role="presentation"
                               style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000000; background-color: #013941; width: 640px;"
                               width="640">
                            <tbody>
                            <tr>
                                <td class="column column-1"
                                                ...
                                                <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td style="padding:0 10px 0 10px;"><a
                                                                    ...
                                                                    target="_blank"></a></td>
                                                        <td style="padding:0 10px 0 10px;"><a
                                                                    href="https://twitter.com/" target="_blank"></a></td>
                                                        <td style="padding:0 10px 0 10px;"><a
                                                                    href="https://instagram.com/" target="_blank"></a></td>
                                                        <td style="padding:0 10px 0 10px;"><a
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div class="txtTinyMce-wrapper"
                                                        ...
                                                        <p style="margin: 0; font-size: 14px; text-align: center;"><span
                                                                    style="color:#95979c;font-size:12px;">Utter Vision Copyright © 2022</span>
                                                        </p>
                                                        <p style="margin: 0; font-size: 14px; text-align: center;">Be
                                                            Happy!</p>
                                                    </div>
                                                </div>
                                            </td>
