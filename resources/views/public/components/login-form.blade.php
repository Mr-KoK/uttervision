<div class="login-form text-center">
    <form method="POST" action="javascript:void(0)">
        ...
        <div class="actions-btn">
            <button type="submit" class="login-btn green-btn btn-login btn-login-login">
                login
            </button>
            <div class="user-activity">
                ...
                <a href="{{route('member.reset.password')}}">Forget Password</a>
            </div>
            <p class="register-action white-btn mt-4">Create New Account!</p>
